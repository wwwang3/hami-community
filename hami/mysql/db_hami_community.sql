...
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES (1, 'wang3', 'wang3.top@qq.com', 'user', '$2a$10$Lo9MdkPkR5rz88TiJA7NG.n8FdErSuzYmLLqCgNdUYLwgma7iOgJu', 1, 0, '2023-09-02 22:54:23.000', '2023-09-02 22:54:23.000');
INSERT INTO `account` VALUES (2, 'wang5', '2780348784@qq.com', 'user', '$2a$10$dYlpHE6UQIzMQ2aDAbB3U.aNabXWwRXFEykOCfM8jUhTsuUpLIOji', 1, 0, '2023-09-02 23:07:34.000', '2023-09-02 23:07:34.000');
...
CREATE TABLE `article_stat`  (
  ...
  `ctime` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `mtime` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  `hot_rank` decimal(10, 3) GENERATED ALWAYS AS (((((`likes` * 10.331) + (`comments` * 2.16)) + (`collects` * 3.2)) + (`views` * 0.33))) STORED NOT NULL,
...
CREATE TABLE `article_tag`  (
  ...
  `ctime` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  `mtime` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `tag` VALUES (1057, 'Canal', 1, 10005, 0, '2023-09-14 21:25:42.000', '2023-09-14 21:25:42.000');
INSERT INTO `tag` VALUES (1059, 'Canal', 1, 10003, 0, '2023-09-05 13:49:26.000', '2023-09-05 14:23:00.000');
INSERT INTO `tag` VALUES (1060, 'Flink', 1, 10005, 0, '2023-09-05 14:26:08.000', '2023-09-05 14:29:13.000');
...
CREATE TABLE `user_stat`  (
  ...
  `hot_index` decimal(10, 3) GENERATED ALWAYS AS (((((((`total_articles` * 0.46) + (`total_views` * 0.012)) + (`total_likes` * 4)) + (`total_collects` * 3)) + (`total_comments` * 0.33)) + (`total_followers` * 1.32))) STORED COMMENT 'hot_index' NOT NULL,
  PRIMARY KEY (`user_id`) USING BTREE,
